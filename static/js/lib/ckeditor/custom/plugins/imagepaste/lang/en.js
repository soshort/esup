CKEDITOR.plugins.setLang( 'imagepaste', 'en',
	{
		...
		// File size is over config.imagepaste_maxFileSize OR the server returns HTTP status 413
		fileTooBig : 'The file is too big, please use a smaller one.',

		// The extension matches one of the blacklisted ones in config.imagepaste_invalidExtensions
		invalidExtension : 'Invalid file type, please use only valid files.',

		// The extension isn't included in config.imagepaste_acceptedExtensions
