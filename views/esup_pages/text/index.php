				...
				<table class="table table-hover">
					...
					<?php foreach ($list as $key => $item): ?>
						<tr>
							...
							<td>
								<a href="/esup/<?php echo $model->options['render']['link'] ?>/edit/<?php echo $item->id ?>"><?php echo Text::limit_chars($item->title, 40) ?></a>
							</td>
							<td>
								<span><?php echo $item->key ?></span> <a href="#" class="copy-to-clipboard"><span class="glyphicon glyphicon-copy"></span></a>
							</td>
							<td class="td_sort">
...
<div class="alert alert-warning">
	При изменении или удалении этих параметров, нужно так же изменить или удалить их в коде <a href="/" class="alert-link">внешнего сайта</a>.
</div>
