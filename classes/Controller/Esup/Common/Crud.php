...
class Controller_Esup_Common_Crud extends Controller_Esup_Common {
	...
	{
		/* Set assets for form page */
		$this->assets->single->add(array('ckeditor-cdn', 'yandex-maps-cdn', 'jquery-ui-cdn', 'fancybox-cdn', 'cropper-cdn'));
		$this->assets->pipeline->add('form-js');
		/* Load model */
		$model = ORM::factory($this->model_name);
		/* Add model */
	...
	public function action_edit()
	{
		...
		/* Redirect on list page if model not found */
